    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center mb-8">
          <Button variant="ghost" onClick={() => router.push("/cart")} className="text-blue-600 hover:text-blue-700">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <label className="flex items-center p-4 border-2 border-blue-300 bg-blue-50 rounded-xl cursor-pointer">
                    <input
                      type="radio"
                      name="payment"
                      value="cod"
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-600">Pay when you receive your order</p>
                    </div>
                  </label>
            ...
            <Card>
              ...
              <CardContent>
                    ...
                    <div key={item.id} className="flex items-center space-x-4 p-4 bg-gray-50 rounded-xl">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between mt-1">
                          ...
                          <span className="font-semibold text-blue-600">{formatPrice(item.total)}</span>
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                <Button
                  ...
                  className="w-full mt-6 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 h-14 text-lg font-semibold disabled:opacity-50"
                >
                  {isProcessing ? (
